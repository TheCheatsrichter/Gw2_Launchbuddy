...
namespace Gw2_Launchbuddy.Modifiers
{
    ...
    public class LocalDatFile
    {
        ...
        */
        ...
        {
            Debug.WriteLine("Calculating new HASH for");
...
namespace Gw2_Launchbuddy.Modifiers
{
    public static class LocalDatManager
    {
        ...
        public static void Apply(LocalDatFile file)
        {
            ...
            /*
                Debug.WriteLine("Loginfile wait start at " + DateTime.Now.ToString());
                WaitForLoginfileRelease(EnviromentManager.GwLocaldatPath);
                Debug.WriteLine("Loginfile release at " + DateTime.Now.ToString());
                /*
                Thread.Sleep(3000);
                Debug.WriteLine("Loginfile wait start at " + DateTime.Now.ToString());
                WaitForLoginfileRelease(EnviromentManager.GwLocaldatPath);
        ...
        public static void WaitForLoginfileRelease(LocalDatFile file)
        {
            int i = 0;
